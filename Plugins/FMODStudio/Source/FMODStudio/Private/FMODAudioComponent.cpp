...
void UFMODAudioComponent::OnComponentDestroyed(bool bDestroyingHierarchy)
{
	OnFMODAudioComponentDestroyed.Broadcast(this);
...
void UFMODAudioComponent::BeginPlay()
{
	...
	{
		if (UFMODAudioComponentTrackerSubsystem* const FMODAudioComponentTrackerSubsystem = World->GetSubsystem<UFMODAudioComponentTrackerSubsystem>())
		{
			FMODAudioComponentTrackerSubsystem->AddFMODAudioComponent(this);
		}
	}
}

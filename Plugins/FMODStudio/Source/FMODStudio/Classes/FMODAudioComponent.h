...
public:
	/** Delegate Broad-casted when the FMOD Audio component gets destroyed */
	DECLARE_MULTICAST_DELEGATE_OneParam(FOnFMODAudioComponentDestroyed, UFMODAudioComponent*)
	FOnFMODAudioComponentDestroyed OnFMODAudioComponentDestroyed;
...
// Begin ActorComponent interface.
	...
	/** Called when a component Begin play. */
